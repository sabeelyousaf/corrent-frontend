    ...
    <section className="w-full">
      <div className="w-full flex h-[386px] gap-4">
        ...
        <div className="flex-2 w-full bg-white rounded-lg h-full relative overflow-hidden flex flex-col justify-between">
          <div
            className={`transition-opacity duration-300 h-full ${fade ? 'opacity-0' : 'opacity-100'}`}
          >
            <img
          ...
          <button
            onClick={prevImage}
            className="absolute left-4 top-1/2 -translate-y-1/2 bg-black bg-opacity-50 text-white px-2 py-1 rounded"
          >
            ‹
          </button>
          <button
            onClick={nextImage}
            className="absolute right-4 top-1/2 -translate-y-1/2 bg-black bg-opacity-50 text-white px-2 py-1 rounded"
          >
            ›
          </button>
